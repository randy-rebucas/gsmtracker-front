...
implements OnInit, OnDestroy {
  ...
  // _prePrint() {
  //   // generate qrcode
  //   this.toDataUrl('/assets/images/rx.png', this.printrx);
  // }
  ...
  printrx() { // base64Img
    ...
    html2canvas(content).then(canvas => {
      ...
      pdfDoc.setFont('courier');
      pdfDoc.setFontType('regular');
      pdfDoc.text('No Noon Break Mon - Sat', 95, 44, null, null, 'left');
      // line
      ...
      pdfDoc.setFont('courier');
      pdfDoc.setFontType('regular');
      const dob = datePipe.transform(this.birthdate, 'dd/MM/yyyy');
