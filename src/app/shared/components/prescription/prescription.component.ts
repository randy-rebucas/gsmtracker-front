...
export class PrescriptionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.patientService.getByKey(this.block.transactions.toAddress).subscribe((user) => {
      console.log(user);
      this.user = user;
    });
  ...
  rxHeader(pdfDoc) {
    ...
    pdfDoc.text('Title', pageWidth / 2, 20, null, null, 'center');
    // subtitle
    pdfDoc.setFontSize(14);
    pdfDoc.setFont('courier');
    pdfDoc.setFontType('regular');
    pdfDoc.text('Sub title', pageWidth / 2, 26, null, null, 'center');
    // clinic address
    pdfDoc.setFontSize(10);
    pdfDoc.setFont('courier');
    pdfDoc.setFontType('regular');
    pdfDoc.text('Magsaysay Ave, Taytayan', 10, 35, null, null, 'left');
    ...
    pdfDoc.text('Tel no: xxxxxxxx', 95, 47, null, null, 'left');
    // clinic hour text
    pdfDoc.setFontSize(10);
    pdfDoc.setFont('courier');
    pdfDoc.setFontType('regular');
    ...
    pdfDoc.text('8:00am - 6:00pm', 95, 39, null, null, 'left');
