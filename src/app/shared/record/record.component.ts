...
import { HeightService } from 'src/app/users/record/services/height.service';
import { WeightService } from 'src/app/users/record/services/weight.service';
import { TemperatureService } from 'src/app/users/record/services/temperature.service';
import { BpService } from 'src/app/users/record/services/bp.service';
import { RprService } from 'src/app/users/record/services/rpr.service';
import { PrService } from 'src/app/users/record/services/pr.service';
import { ComplaintService } from 'src/app/users/record/services/complaint.service';
import { EndorsementService } from 'src/app/users/record/services/endorsement.service';
import { PresentIllnessService } from 'src/app/users/record/services/present-illness.service';
import { PastMedicalService } from 'src/app/users/record/services/past-medical.service';
import { SocialService } from 'src/app/users/record/services/social.service';
import { FamilyHistoryService } from 'src/app/users/record/services/family-history.service';
import { OrderService } from 'src/app/users/record/services/order.service';
import { NotesService } from 'src/app/users/record/services/notes.service';
import { ImmunizationService } from 'src/app/users/record/services/immunization.service';
import { PrescriptionService } from 'src/app/users/record/services/prescription.service';
import { AssessmentService } from 'src/app/users/record/services/assessment.service';
import { AllergyService } from 'src/app/users/record/services/allergy.service';
import { ComplaintData } from 'src/app/users/record/models/complaint-data.model';
import { EndorsementData } from 'src/app/users/record/models/endorsement-data.model';
import { PresentIllnessData } from 'src/app/users/record/models/present-illness-data';
import { PastMedicalData } from 'src/app/users/record/models/past-medical-data.model';
import { SocialData } from 'src/app/users/record/models/social-data';
import { FamilyHistoryData } from 'src/app/users/record/models/family-history-data';
import { OrderData } from 'src/app/users/record/models/order-data.model';
import { NoteData } from 'src/app/users/record/models/note.model';
import { ImmunizationData } from 'src/app/users/record/models/immunization-data.model';
import { PrescriptionData } from 'src/app/users/record/models/prescription-data.model';
import { AssessmentData } from 'src/app/users/record/models/assessment-data.model';
import { AllergyData } from 'src/app/users/record/models/allergy-data.model';
@Component({
    selector: 'app-record',
