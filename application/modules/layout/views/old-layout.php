			...
			<div class="navbar-inner">
				...
				<div class="container">
					...
					<ul class="nav pull-right settings">
                        <li><a href="#"><?php echo lang('welcome') . ' ' . $username; ?></a></li>
						...
						<li class="divider-vertical"></li>
						<li><a href="<?php echo site_url('auth/logout'); ?>" class="tip icon logout" data-original-title="<?php echo lang('logout'); ?>" data-placement="bottom"><i class="icon-off"></i></a></li>
					</ul>
