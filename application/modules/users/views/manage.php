						...
						<div class="widget-body-toolbar">
							...
							<div class="row">
								...
								<div class="col-xs-3 col-sm-7 col-md-7 col-lg-7 text-right">
									...
									<?php if(($this->admin_role_id != $this->role_id) ? $this->Mdl_roles->has_permission('users', $this->role_id, 'create',  $this->client_id) : true) { ?>
...
<script type="text/javascript">
	...
	var can_view = 	'<?php echo ($this->admin_role_id != $this->role_id) ? $this->Mdl_roles->has_permission('users', $this->role_id, 'view',   $this->client_id) : true; ?>';
	var can_update = '<?php echo ($this->admin_role_id != $this->role_id) ? $this->Mdl_roles->has_permission('users', $this->role_id, 'update',   $this->client_id) : true; ?>';
	var can_delete = '<?php echo ($this->admin_role_id != $this->role_id) ? $this->Mdl_roles->has_permission('users', $this->role_id, 'delete',   $this->client_id) : true; ?>';
		...
		*/	
		...
		/* BASIC ;*/
			...
			$('#table-patients').dataTable({
		        ...
		        "ajax": {
		            url: BASE_URL + 'users/ajax/get_data/',
		            type: 'POST',
		            data: {
		                filter: 0
		            }
